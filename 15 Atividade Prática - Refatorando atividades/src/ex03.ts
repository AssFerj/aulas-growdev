...
let preco: number = Number(prompt('Digite o valor do produto:'));
let parcelamento: number = Number(prompt('Digite a quantidade de parcelas:'));
let taxaAvista: number = preco * 2.5 / 100;
let juros6a10: number = preco * 6 / 100;
let juros11a15: number = preco * 13 / 100;
