...
let totalEleitores: number = Number(prompt('Quantos eleitores tem seu município?'));
let votosBrancos: number = Number(prompt('Digite o total de votos em branco.'));
let votosNulos: number = Number(prompt('Digite o total de votos nulos.'));
let votosValidos: number = Number(prompt('Digite o total de votos válidos.'));

let centoBrancos: number = votosBrancos / totalEleitores * 100
let centoNulos: number = votosNulos / totalEleitores * 100
let centoValidos: number = votosValidos / totalEleitores * 100
