...
let A: number = Number(prompt("Digite um número:"))
let B: number = Number(prompt("Digite mais um número:"))
let C: number = Number(prompt("Digite outro número:"))
