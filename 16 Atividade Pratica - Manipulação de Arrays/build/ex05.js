...
const arrayProduct = ['Geladeira', 'Fogão', 'Smart TV', 'Notebook', 'Microondas', 'Minisystem', 'Mesa'];
const product = prompt('Escolha um dos produtos:\nGeladeira\nFogão\nSmart TV\nNotebook\nMicroondas\nMinisystem\nMesa');
const productIndex = arrayProduct.find(element => element == product);
